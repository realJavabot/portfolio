...
function init() {
    ...
    const matcapTexture = new THREE.TextureLoader().load('water2.jpg');
    ...
    can.addEventListener("mousedown", (e) => {raycaster.mousedown(e);});
    can.addEventListener("mouseup", (e) => {raycaster.mouseup(e);});
    can.addEventListener("mousemove", (e) => {raycaster.mousemove(e);});
    // }, 500);
